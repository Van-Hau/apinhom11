...
module.exports = {
    getAll: async ()=>new Promise(
        (resolve,reject)=>{
            ...
            let sql = 'select * from tinh_thanh'
    ...
    get: async (id)=>new Promise(
        (resolve,reject)=>{
            ...
            let sql = 'select * from tinh_thanh where id=?'
            pool.getConnection(function(err, connection) {
                if (err) {
                    connection.release();
                    res.json({ "code": 100, "status": "Error in connection database" });
    ...
    update:async (id,data)=>new Promise(
        (resolve,reject)=>{
            ...
            let sql = 'UPDATE tinh_thanh SET ? WHERE id = ?'
            pool.getConnection(function(err, connection) {
                if (err) {
                    connection.release();
                    res.json({ "code": 100, "status": "Error in connection database" });
   ...
   ,
    delete:async (id)=>new Promise(
        (resolve,reject)=>{
            ...
            let sql = 'DELETE FROM tinh_thanh WHERE id = ?'
            pool.getConnection(function(err, connection) {
                if (err) {
                    connection.release();
                    res.json({ "code": 100, "status": "Error in connection database" });
    ...
    insert:async (data)=>new Promise(
        (resolve,reject)=>{
            ...
            let sql = 'INSERT INTO tinh_thanh SET ?'
            pool.getConnection(function(err, connection) {
                if (err) {
                    connection.release();
                    res.json({ "code": 100, "status": "Error in connection database" });
