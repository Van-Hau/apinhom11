...
module.exports = {
    getAll: async ()=>new Promise(
        (resolve,reject)=>{
         ...
         ,tinh_thanh.name as Province_Fact,khu_vuc.area as yArea_Fact,dateOpen.date as Date_Fact,dateOpen.date_of_week,giai.Name_award as Name_award_Fact,dim_expire.date as Date_expire_Fact
    ...
    ,
    getByProvinceTop3: async (province)=>new Promise(
        (resolve,reject)=>{
            const handler = (error, result) => {
                if (error) {
                reject(error);
